...
data class InventoryInput(val warehouseId: String? = null, val priceList: String? = null, val query: String? = null)
class FetchInventoryItemUseCase(
    ...
    override suspend fun useCaseFunction(input: InventoryInput): Flow<PagingData<ItemBO>> {
        return repo.getItems(input.warehouseId, input.priceList, input.query)
    }
}